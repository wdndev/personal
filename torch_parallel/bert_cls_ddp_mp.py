""" 分布式数据并行 (DistributedDataParallel) 分布式训练, 使用multiprocess启动
"""
...
class TrainArgs:
    ...
    ckpt_path = "output/bert_cls_ddp_mp_4.pt"
...
# nohup python bert_cls_ddp_mp.py --local_world_size=2  > logs/bert_cls_ddp_mp_2.log 2>&1 &

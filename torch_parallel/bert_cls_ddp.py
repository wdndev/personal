""" 分布式数据并行 (DistributedDataParallel) 分布式训练
"""
...
class TrainArgs:
    ...
    ckpt_path = "output/bert_cls_ddp_4.pt"
...
# nohup python -m torch.distributed.launch --nnode=1 --node_rank=0 --nproc_per_node=2 --use_env bert_cls_ddp.py --local_world_size=2 > logs/bert_cls_ddp_2.log 2>&1 &
